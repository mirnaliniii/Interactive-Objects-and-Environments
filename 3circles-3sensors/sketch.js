...
function gotData() {
    ...
    console.log("splitter[1]" + splitter[1]);
    diameter1 = splitter[1];

    console.log("splitter[2]" + splitter[2]);
...
function draw() {
    ...
    ellipseMode(RADIUS);
    fill(255, 0, 0);
    ellipse(200, 200, diameter0, diameter0);

    ellipseMode(RADIUS);
    fill(0, 255, 0);
    ellipse(400, 200, diameter1, diameter1);

    ellipseMode(RADIUS);
    fill(0, 0, 255);
    ellipse(600, 200, diameter2, diameter2);
